...
async function initAccessGate() {
    ...
    try {
        ...
        linkEl.href = 'login.html?next=resources.html';
        linkEl.hidden = false;
    ...
    if (!allowed) {
        messageEl.textContent = `This page belongs to Standard ${PAGE_STANDARD_NUMBER} (Resources & Learning Facilities). ` +
